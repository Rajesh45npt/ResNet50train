...
TestResultonTrianData = partialModel.evaluate_generator(TrainImageDataGenerator, verbose=1)
print(TestResultonTrianData )

TestResultonTestData = partialModel.evaluate_generator(TestImageDataGenerator, verbose=1)
print(TestResultonTestData )
