...
partialModel.load_weights("fulltrainweightsfile3.h5")
...
# =============================================================================
TrainingResult = partialModel.fit_generator(TrainImageDataGenerator, steps_per_epoch=len(TrainImageDataGenerator), validation_data=TestImageDataGenerator, validation_steps=len(TestImageDataGenerator), shuffle=True, verbose=1, epochs=5, workers = 12, use_multiprocessing=True, max_queue_size = 24)

partialModel.save_weights('fulltrainweightsfile4.h5')
